...
// PushbotsLight
#define COCOAPODS_POD_AVAILABLE_PushbotsLight
#define COCOAPODS_VERSION_MAJOR_PushbotsLight 0
#define COCOAPODS_VERSION_MINOR_PushbotsLight 1
#define COCOAPODS_VERSION_PATCH_PushbotsLight 0
